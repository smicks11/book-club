                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    GestureDetector(
                                      onTap: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (ctx) => Preferences()));
                                     },
                                ...
                                children: days.map((e) =>
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            color:  selectedDay == e ? HexColor('001E97') : Colors.transparent,
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: [
                            Timetable(course: 'CSC 302', time: '10 AM - 11 AM',),
                            Container(
                              height: 60,
                              width: 0.6,
                              color: HexColor('E4E7F1'),
                            ),
                            Timetable(course: 'CSC 302', time: '05 AM - 07 PM',)
                          ],
                        ),
                      ),
                    )
